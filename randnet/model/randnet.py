...
class RandNetSmall(keras.Model):
    ...
    def __init__(self, num_classes, kernel_regularizer=None, bias_regularizer=None):
        """

        Args:
            num_classes: The number of classes the dataset has
            bias_regularizer:  Regularizer function applied to all bias weights
            kernel_regularizer: Regularizer function applied to all kernel weights
        """
